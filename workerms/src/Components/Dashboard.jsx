        ...
        <Paper square elevation={1} sx={{ backgroundColor: "slategrey", minHeight: "100vh" }}>
          <Stack direction="column" spacing={4} justifyContent="space-between" alignSelf="strech">
            ...
            <Stack pl={4} direction="column" spacing={2}>
              ...
              <Box display="flex" flexDirection="row" alignItems="center" gap={1.5} component={Link} href="/worker" underline="none"><Box><PeopleIcon /></Box> <Typography >Manage Employees</Typography></Box>
              <Box display="flex" flexDirection="row" gap={1.5} alignItems="center" component={Link} href="/category" underline="none"><Box><LibraryBooksIcon /></Box> <Typography >Category</Typography></Box>
