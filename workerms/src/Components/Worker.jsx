        ...
        <TableBody>
          {worker.map((row) => (
            ...
            >
              ...
              <TableCell align="right"><Link to={`/dashboard/edit_worker/`+row.id} style={{ textDecoration: "none", borderRadius: 5, paddingLeft: 15, paddingRight:15,paddingTop:7,paddingBottom:7, backgroundColor: "green", color: 'white' }}>Edit</Link><Button color='warning' size='small' variant='contained' sx={{ml:2}}>Delete</Button></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
